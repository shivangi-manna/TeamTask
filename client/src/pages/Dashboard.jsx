...
export default function Dashboard() {
  ...
  const handleCreateProject = async (e) => {
    ...
    } catch (err) { alert(err.response?.data?.detail || 'Error creating project'); }
    ...
    <>
      ...
      <div className="page-content fade-in">
        <div className="page-header" style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' }}>
          ...
          {user?.role === 'ADMIN' && (
            <button className="btn btn-primary" onClick={() => setShowModal(true)} style={{ padding: '0.8rem 1.5rem', fontSize: '0.95rem' }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
        ...
        <div className="stats-grid">
          <div className="stat-card slide-up clickable-card" onClick={() => navigate('/projects')} style={{ cursor: 'pointer', transition: 'all 0.2s', border: '1px solid rgba(255,255,255,0.05)' }} title="Click to view all Active Projects">
            ...
            <div className="stat-info">
              ...
              <p>Active Projects <span style={{ fontSize: '0.75rem', color: 'var(--accent-indigo)', fontWeight: 700 }}>↗ View</span></p>
            </div>
          </div>
          <div className="stat-card slide-up clickable-card" onClick={() => navigate('/projects')} style={{ animationDelay: '0.05s', cursor: 'pointer', transition: 'all 0.2s', border: '1px solid rgba(255,255,255,0.05)' }} title="Click to view all Tasks">
            ...
            <div className="stat-info">
              ...
              <p>Total Tasks <span style={{ fontSize: '0.75rem', color: 'var(--accent-cyan)', fontWeight: 700 }}>↗ View</span></p>
            </div>
          </div>
          <div className="stat-card slide-up clickable-card" onClick={() => navigate('/projects')} style={{ animationDelay: '0.1s', cursor: 'pointer', transition: 'all 0.2s', border: '1px solid rgba(255,255,255,0.05)' }} title="Click to inspect project progress">
            ...
            <div className="stat-info">
              ...
              <p>Completion Rate <span style={{ fontSize: '0.75rem', color: 'var(--accent-green)', fontWeight: 700 }}>↗ View</span></p>
            </div>
          </div>
          <div className="stat-card slide-up clickable-card" onClick={() => navigate('/projects')} style={{ animationDelay: '0.15s', cursor: 'pointer', transition: 'all 0.2s', border: '1px solid rgba(255,255,255,0.05)' }} title="Click to check project boards for overdue items">
            ...
            <div className="stat-info">
              ...
              <p>Overdue Tasks <span style={{ fontSize: '0.75rem', color: '#fb7185', fontWeight: 700 }}>↗ View</span></p>
            </div>
          </div>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(450px, 1fr))', gap: '1.75rem' }}>
          <div className="card slide-up" style={{ animationDelay: '0.2s' }}>
            ...
            {chartData.length > 0 ? (
              ...
              <div className="empty-state" style={{ padding: '3rem 1rem' }}>
                <p style={{ marginBottom: '1.5rem' }}>No tasks available for distribution</p>
                {user?.role === 'ADMIN' && (
                  <button className="btn btn-primary" onClick={() => setShowModal(true)}>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
          ...
          <div className="card slide-up" style={{ animationDelay: '0.25s', display: 'flex', flexDirection: 'column' }}>
            ...
            {myTasks.length === 0 ? (
              <div className="empty-state" style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '3rem 1rem' }}>
                ...
                <h3>All caught up!</h3>
                <p style={{ marginBottom: '1.5rem' }}>No tasks are currently assigned to you.</p>
                {user?.role === 'ADMIN' && (
                  <button className="btn btn-primary" onClick={() => setShowModal(true)}>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
